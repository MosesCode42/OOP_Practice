class Inventory:
    ...
    def add_item(self, name, price, quantity):
        ...
        self.items[name] = {"name": name, "price": price, "qauntity": quantity}
    ...
    def delete_item(self, name):
        ...
        self.item_counts -= self.items[name]["quantity"]
        del self.items[name]
        return True
    ...
    def get_most_stocked_item(self):
        ...
        for item in self.items.values():
            ...
            if quantity > largest_quantity:
                most_stock_item_name = name
                largest_quantity = quantity
                
        return most_stock_item_name
